...
이 장에서 시간표를 직접 훑는 알고리즘 RAPTOR 를 구현합니다. 직접 구현하는 세 가지 중 두 번째이고, 150줄 정도입니다.
...
우선순위 큐도 정렬도 없이 노선을 순서대로 훑기만 합니다. 이 단순함이 RAPTOR 가 빠른 이유입니다.
...
이 알고리즘에서 새로운 것은 2번의 "손에 든 차"입니다. 패턴을 한 번 훑으면서 타고 있으면 계속 타고, 더 이른 차가 있으면 갈아탑니다.
...
**80밀리초에 4,156개 정류장까지의 도착시각을 전부 구했습니다.** 다익스트라로 한 쌍씩 4,156번 물었다면 훨씬 오래 걸립니다.
